...
public class ModShowScopeGraph implements TaskDef<ModShowScopeGraph.Args, CommandOutput> {
    ...
    @Override public CommandOutput exec(ExecContext context, Args args) throws Exception {
        ...
        final ModAnalyzeMulti.@Nullable Output output = context.require(analyze, new ModAnalyzeMulti.Input(args.project, walker, matcher, parse.createNullableRecoverableAstFunction()));
        if(output == null) {
